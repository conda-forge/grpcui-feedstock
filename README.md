...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/grpcui-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/grpcui-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `grpcui` available on your platform:
...
```
pixi search grpcui --channel conda-forge
```
